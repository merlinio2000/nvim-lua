...
keymap("n", "sld", "<cmd>Lspsaga show_line_diagnostics<CR>", { silent = true })

-- Show cursor diagnostics
keymap("n", "scd", "<cmd>Lspsaga show_cursor_diagnostics<CR>", { silent = true })
...
end, { silent = true, desc = 'Lspsaga go to next error' })
keymap("n", "]e", function()
...
keymap("n", "sK", "<cmd>Lspsaga hover_doc ++keep<CR>", { silent = true })
